...
contract ChallengeTest is Test {
    ...
    function setUp() public {
        ...
        aWeth = IWETH(0xe50fA9b3c56FfB159cB0FCA61F5c9D750e8128c8);
        usdc = new USDCToken(
            "USDC",
            "USDC",
            6,
    ...
    function test_buy_polizy_borrow_yes() public {
        ...
        weth.approve(address(marketInteractions), balAfter);
        marketInteractions.supplyLiquidity(10e18, address(this));
        address token = 0xba5DdD1f9d7F570dc94a51479a000E3BCE967196;
        uint256 balance = aWeth.balanceOf(address(this));
        console.log(balance);

        marketInteractions.borrowWETH(50e18, token, address(this));

        challenge.buyInsurance(address(this));
        uint balance1 = policyNFT.balanceOf(address(this));
        assertEq(balance1, 1);
    }
    ...
    function test_claim_insurance() public {
        ...
        marketInteractions.borrowWETH(200e18, token, address(this));
